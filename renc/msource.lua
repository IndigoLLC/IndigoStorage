-- the test functions are ass lol, too lazy to fix 

if shared.moREnc and not shared.moREncDebug then
    return warn("MoreRENC for " .. identifyexecutor() .. " is already loaded!")
end
...
print(("RENC Functions Loaded | Roblox version: %s | Indigo")
shared.moREnc = true
