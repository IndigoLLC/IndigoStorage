--[[-----------------------------------------------------------------------------------------------------------------
    ...
    modified by FurryBoy (https://scriptblox.com/u/FurryBoy)

    Credits:
        vxsty (https://scriptblox.com/u/vxsty)
    ...
    To be added:
        Add setfflag()
        Add getfflag()
        -- For these 2 above, i couldn't find solutions yet. 

    Added:
        setfpscap()
        getfpscap()
        hookfunction() -- not sure if it'll work
        isnetworkowner() -- not sure if it'll work
...
funcs.setfpscap=function(value)
 SetTo=value or 0
...
funcs.hookfunction=function(func, rep)
 for i,v in pairs(getfenv()) do
  if v==func then getfenv()[i] = rep end
 end
end
...
local Count=0
local Total=0
print("Running Indigo | Roblox "..version())
